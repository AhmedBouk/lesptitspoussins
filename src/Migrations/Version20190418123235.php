 ...
 */
final class Version20190418123235 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        , statutcondition BOOLEAN NOT NULL, token VARCHAR(255) DEFAULT NULL COLLATE BINARY, telephone VARCHAR(255) DEFAULT NULL, codepostal VARCHAR(255) DEFAULT NULL)');
