 ...
 */
final class Version20190415142442 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__parentt AS SELECT id, nom, prenom, mail, ville, codepostal, adresse, telephone, password, created_at, updated_at, created_at_abonnement, statut_abonnement, date_duree, is_enabled, roles, statutcondition, token FROM parentt');
        ...
        $this->addSql('INSERT INTO parentt (id, nom, prenom, mail, ville, codepostal, adresse, telephone, password, created_at, updated_at, created_at_abonnement, statut_abonnement, date_duree, is_enabled, roles, statutcondition, token) SELECT id, nom, prenom, mail, ville, codepostal, adresse, telephone, password, created_at, updated_at, created_at_abonnement, statut_abonnement, date_duree, is_enabled, roles, statutcondition, token FROM __temp__parentt');
    ...
    public function down(Schema $schema) : void
    {
        ...
        , horaire CLOB DEFAULT \'NULL --(DC2Type:array)\' COLLATE BINARY --(DC2Type:array)
