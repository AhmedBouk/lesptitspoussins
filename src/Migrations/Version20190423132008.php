 ...
 */
final class Version20190423132008 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__pro_profil AS SELECT id, nom_entreprise, mail, ville, adresse, password, created_at, updated_at, nombre_personnel, disponibilite, tarif, statut, nombredeplace, roles, token, longitude, latitude, codepostal, telephone, avatar, horaire FROM pro_profil');
        ...
        , token VARCHAR(255) DEFAULT NULL COLLATE BINARY, longitude NUMERIC(10, 10) DEFAULT NULL, latitude NUMERIC(10, 10) DEFAULT NULL, codepostal VARCHAR(255) DEFAULT NULL COLLATE BINARY, telephone VARCHAR(255) DEFAULT NULL COLLATE BINARY, avatar VARCHAR(255) DEFAULT NULL COLLATE BINARY, horaire CLOB DEFAULT NULL --(DC2Type:json)
        )');
        $this->addSql('INSERT INTO pro_profil (id, nom_entreprise, mail, ville, adresse, password, created_at, updated_at, nombre_personnel, disponibilite, tarif, statut, nombredeplace, roles, token, longitude, latitude, codepostal, telephone, avatar, horaire) SELECT id, nom_entreprise, mail, ville, adresse, password, created_at, updated_at, nombre_personnel, disponibilite, tarif, statut, nombredeplace, roles, token, longitude, latitude, codepostal, telephone, avatar, horaire FROM __temp__pro_profil');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE pro_profil');
        $this->addSql('CREATE TABLE pro_profil (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, nom_entreprise VARCHAR(255) NOT NULL, mail VARCHAR(255) NOT NULL, ville VARCHAR(255) DEFAULT NULL, codepostal VARCHAR(255) DEFAULT NULL, adresse CLOB DEFAULT NULL, telephone VARCHAR(255) DEFAULT NULL, password VARCHAR(255) NOT NULL, token VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, nombre_personnel INTEGER DEFAULT NULL, disponibilite BOOLEAN NOT NULL, tarif NUMERIC(10, 10) DEFAULT NULL, statut BOOLEAN NOT NULL, nombredeplace INTEGER NOT NULL, roles CLOB NOT NULL --(DC2Type:array)
        , longitude NUMERIC(10, 10) DEFAULT NULL, latitude NUMERIC(10, 10) DEFAULT NULL, avatar VARCHAR(255) DEFAULT NULL, horaire CLOB DEFAULT \'NULL --(DC2Type:json)\' COLLATE BINARY --(DC2Type:json)
        )');
