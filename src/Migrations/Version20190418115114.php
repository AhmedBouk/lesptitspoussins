 ...
 */
final class Version20190418115114 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        , statutcondition BOOLEAN NOT NULL, token VARCHAR(255) DEFAULT NULL COLLATE BINARY, telephone INTEGER DEFAULT NULL, codepostal INTEGER DEFAULT NULL, password_requested_at DATETIME DEFAULT NULL, revenu VARCHAR(255) DEFAULT NULL, attestationcaf VARCHAR(255) DEFAULT NULL, justificatifdomicile VARCHAR(255) DEFAULT NULL, impots VARCHAR(255) DEFAULT NULL, livretdefamille VARCHAR(255) DEFAULT NULL)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        , statutcondition BOOLEAN NOT NULL, codepostal VARCHAR(255) DEFAULT NULL COLLATE BINARY, telephone VARCHAR(255) DEFAULT NULL COLLATE BINARY)');
