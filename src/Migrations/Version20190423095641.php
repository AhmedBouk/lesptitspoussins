 ...
 */
final class Version20190423095641 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        , statut BOOLEAN NOT NULL, nombredeplace INTEGER NOT NULL, codepostal VARCHAR(255) DEFAULT NULL, telephone VARCHAR(255) DEFAULT NULL, token VARCHAR(255) DEFAULT NULL, roles CLOB NOT NULL --(DC2Type:array)
        , longitude NUMERIC(10, 10) DEFAULT NULL, latitude NUMERIC(10, 10) DEFAULT NULL, avatar VARCHAR(255) DEFAULT NULL)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        , statut BOOLEAN NOT NULL, nombredeplace INTEGER NOT NULL, codepostal INTEGER DEFAULT NULL, telephone INTEGER DEFAULT NULL, token VARCHAR(255) NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO pro_profil (id, nom_entreprise, mail, ville, codepostal, adresse, telephone, password, token, created_at, updated_at, nombre_personnel, disponibilite, tarif, horaire, statut, nombredeplace) SELECT id, nom_entreprise, mail, ville, codepostal, adresse, telephone, password, token, created_at, updated_at, nombre_personnel, disponibilite, tarif, horaire, statut, nombredeplace FROM __temp__pro_profil');
        $this->addSql('DROP TABLE __temp__pro_profil');
        $this->addSql('DROP INDEX IDX_564122682AD18E6A');
        $this->addSql('DROP INDEX IDX_5641226837955E80');
