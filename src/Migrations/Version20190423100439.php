 ...
 */
final class Version20190423100439 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__parentt AS SELECT id, nom, prenom, mail, ville, adresse, password, created_at, updated_at, created_at_abonnement, statut_abonnement, date_duree, is_enabled, roles, statutcondition, token, telephone, codepostal FROM parentt');
        $this->addSql('DROP TABLE parentt');
        $this->addSql('CREATE TABLE parentt (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, nom VARCHAR(255) DEFAULT NULL COLLATE BINARY, prenom VARCHAR(255) DEFAULT NULL COLLATE BINARY, mail VARCHAR(255) NOT NULL COLLATE BINARY, ville VARCHAR(255) DEFAULT NULL COLLATE BINARY, adresse CLOB DEFAULT NULL COLLATE BINARY, password VARCHAR(150) NOT NULL COLLATE BINARY, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, created_at_abonnement DATETIME DEFAULT NULL, statut_abonnement BOOLEAN NOT NULL, date_duree DATE DEFAULT NULL, is_enabled BOOLEAN NOT NULL, roles CLOB NOT NULL COLLATE BINARY --(DC2Type:array)
        , statutcondition BOOLEAN NOT NULL, token VARCHAR(255) DEFAULT NULL COLLATE BINARY, telephone VARCHAR(255) DEFAULT NULL, codepostal VARCHAR(255) DEFAULT NULL, revenu VARCHAR(255) DEFAULT NULL, attestationcaf VARCHAR(255) DEFAULT NULL, justificatifdomicile VARCHAR(255) DEFAULT NULL, impots VARCHAR(255) DEFAULT NULL, livretdefamille VARCHAR(255) DEFAULT NULL)');
        $this->addSql('INSERT INTO parentt (id, nom, prenom, mail, ville, adresse, password, created_at, updated_at, created_at_abonnement, statut_abonnement, date_duree, is_enabled, roles, statutcondition, token, telephone, codepostal) SELECT id, nom, prenom, mail, ville, adresse, password, created_at, updated_at, created_at_abonnement, statut_abonnement, date_duree, is_enabled, roles, statutcondition, token, telephone, codepostal FROM __temp__parentt');
        ...
        , token VARCHAR(255) DEFAULT NULL COLLATE BINARY, longitude NUMERIC(10, 10) DEFAULT NULL, latitude NUMERIC(10, 10) DEFAULT NULL, codepostal VARCHAR(255) DEFAULT NULL, telephone VARCHAR(255) DEFAULT NULL, horaire CLOB DEFAULT NULL --(DC2Type:json)
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE parentt');
        $this->addSql('CREATE TABLE parentt (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, nom VARCHAR(255) DEFAULT NULL, prenom VARCHAR(255) DEFAULT NULL, mail VARCHAR(255) NOT NULL, ville VARCHAR(255) DEFAULT NULL, adresse CLOB DEFAULT NULL, password VARCHAR(150) NOT NULL, token VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, created_at_abonnement DATETIME DEFAULT NULL, statut_abonnement BOOLEAN NOT NULL, date_duree DATE DEFAULT NULL, is_enabled BOOLEAN NOT NULL, roles CLOB NOT NULL --(DC2Type:array)
        , statutcondition BOOLEAN NOT NULL, codepostal INTEGER DEFAULT NULL, telephone INTEGER DEFAULT NULL, password_requested_at DATETIME DEFAULT NULL)');
        ...
        , longitude NUMERIC(10, 10) DEFAULT NULL, latitude NUMERIC(10, 10) DEFAULT NULL, codepostal INTEGER DEFAULT NULL, telephone INTEGER DEFAULT NULL, horaire CLOB DEFAULT \'NULL --(DC2Type:json)\' COLLATE BINARY --(DC2Type:json)
        )');
