 ...
 */
final class Version20190423103127 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__pro_profil AS SELECT id, nom_entreprise, mail, ville, adresse, password, created_at, updated_at, nombre_personnel, disponibilite, tarif, statut, nombredeplace, roles, token, longitude, latitude, codepostal, telephone, horaire, avatar FROM pro_profil');
        ...
        $this->addSql('INSERT INTO pro_profil (id, nom_entreprise, mail, ville, adresse, password, created_at, updated_at, nombre_personnel, disponibilite, tarif, statut, nombredeplace, roles, token, longitude, latitude, codepostal, telephone, horaire, avatar) SELECT id, nom_entreprise, mail, ville, adresse, password, created_at, updated_at, nombre_personnel, disponibilite, tarif, statut, nombredeplace, roles, token, longitude, latitude, codepostal, telephone, horaire, avatar FROM __temp__pro_profil');
