 ...
 */
final class Version20190423102517 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__pro_profil AS SELECT id, nom_entreprise, mail, ville, codepostal, adresse, telephone, password, created_at, updated_at, nombre_personnel, disponibilite, tarif, statut, nombredeplace, roles, token, longitude, latitude, horaire, avatar FROM pro_profil');
        $this->addSql('DROP TABLE pro_profil');
        $this->addSql('CREATE TABLE pro_profil (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, nom_entreprise VARCHAR(255) NOT NULL COLLATE BINARY, mail VARCHAR(255) NOT NULL COLLATE BINARY, ville VARCHAR(255) DEFAULT NULL COLLATE BINARY, adresse CLOB DEFAULT NULL COLLATE BINARY, password VARCHAR(255) NOT NULL COLLATE BINARY, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, nombre_personnel INTEGER DEFAULT NULL, disponibilite BOOLEAN NOT NULL, tarif NUMERIC(10, 10) DEFAULT NULL, statut BOOLEAN NOT NULL, nombredeplace INTEGER NOT NULL, roles CLOB NOT NULL COLLATE BINARY --(DC2Type:array)
        , token VARCHAR(255) DEFAULT NULL COLLATE BINARY, longitude NUMERIC(10, 10) DEFAULT NULL, latitude NUMERIC(10, 10) DEFAULT NULL, avatar VARCHAR(255) DEFAULT NULL COLLATE BINARY, codepostal VARCHAR(255) DEFAULT NULL, telephone VARCHAR(255) DEFAULT NULL, horaire CLOB DEFAULT NULL --(DC2Type:json)
        )');
        $this->addSql('INSERT INTO pro_profil (id, nom_entreprise, mail, ville, codepostal, adresse, telephone, password, created_at, updated_at, nombre_personnel, disponibilite, tarif, statut, nombredeplace, roles, token, longitude, latitude, horaire, avatar) SELECT id, nom_entreprise, mail, ville, codepostal, adresse, telephone, password, created_at, updated_at, nombre_personnel, disponibilite, tarif, statut, nombredeplace, roles, token, longitude, latitude, horaire, avatar FROM __temp__pro_profil');
        ...
        $this->addSql('ALTER TABLE parentt ADD COLUMN revenu VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE parentt ADD COLUMN attestationcaf VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE parentt ADD COLUMN justificatifdomicile VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE parentt ADD COLUMN impots VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE parentt ADD COLUMN livretdefamille VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__parentt AS SELECT id, nom, prenom, mail, ville, codepostal, adresse, telephone, password, token, created_at, updated_at, created_at_abonnement, statut_abonnement, date_duree, is_enabled, roles, statutcondition FROM parentt');
        $this->addSql('DROP TABLE parentt');
        $this->addSql('CREATE TABLE parentt (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, nom VARCHAR(255) DEFAULT NULL, prenom VARCHAR(255) DEFAULT NULL, mail VARCHAR(255) NOT NULL, ville VARCHAR(255) DEFAULT NULL, codepostal VARCHAR(255) DEFAULT NULL, adresse CLOB DEFAULT NULL, telephone VARCHAR(255) DEFAULT NULL, password VARCHAR(150) NOT NULL, token VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, created_at_abonnement DATETIME DEFAULT NULL, statut_abonnement BOOLEAN NOT NULL, date_duree DATE DEFAULT NULL, is_enabled BOOLEAN NOT NULL, roles CLOB NOT NULL --(DC2Type:array)
        , statutcondition BOOLEAN NOT NULL)');
        $this->addSql('INSERT INTO parentt (id, nom, prenom, mail, ville, codepostal, adresse, telephone, password, token, created_at, updated_at, created_at_abonnement, statut_abonnement, date_duree, is_enabled, roles, statutcondition) SELECT id, nom, prenom, mail, ville, codepostal, adresse, telephone, password, token, created_at, updated_at, created_at_abonnement, statut_abonnement, date_duree, is_enabled, roles, statutcondition FROM __temp__parentt');
        ...
        $this->addSql('DROP INDEX UNIQ_40D43EC0C567A17');
        $this->addSql('DROP INDEX UNIQ_40D43EC05126AC48');
        $this->addSql('CREATE TEMPORARY TABLE __temp__pro_profil AS SELECT id, nom_entreprise, mail, ville, codepostal, adresse, telephone, password, token, created_at, updated_at, nombre_personnel, disponibilite, tarif, horaire, statut, nombredeplace, roles, longitude, latitude, avatar FROM pro_profil');
        $this->addSql('DROP TABLE pro_profil');
        $this->addSql('CREATE TABLE pro_profil (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, nom_entreprise VARCHAR(255) NOT NULL, mail VARCHAR(255) NOT NULL, ville VARCHAR(255) DEFAULT NULL, adresse CLOB DEFAULT NULL, password VARCHAR(255) NOT NULL, token VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, nombre_personnel INTEGER DEFAULT NULL, disponibilite BOOLEAN NOT NULL, tarif NUMERIC(10, 10) DEFAULT NULL, statut BOOLEAN NOT NULL, nombredeplace INTEGER NOT NULL, roles CLOB NOT NULL --(DC2Type:array)
        , longitude NUMERIC(10, 10) DEFAULT NULL, latitude NUMERIC(10, 10) DEFAULT NULL, avatar VARCHAR(255) DEFAULT NULL, codepostal INTEGER DEFAULT NULL, telephone INTEGER DEFAULT NULL, horaire CLOB DEFAULT \'NULL --(DC2Type:json)\' COLLATE BINARY --(DC2Type:json)
        )');
        $this->addSql('INSERT INTO pro_profil (id, nom_entreprise, mail, ville, codepostal, adresse, telephone, password, token, created_at, updated_at, nombre_personnel, disponibilite, tarif, horaire, statut, nombredeplace, roles, longitude, latitude, avatar) SELECT id, nom_entreprise, mail, ville, codepostal, adresse, telephone, password, token, created_at, updated_at, nombre_personnel, disponibilite, tarif, horaire, statut, nombredeplace, roles, longitude, latitude, avatar FROM __temp__pro_profil');
        $this->addSql('DROP TABLE __temp__pro_profil');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_40D43EC0C567A17 ON pro_profil (nom_entreprise)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_40D43EC05126AC48 ON pro_profil (mail)');
        $this->addSql('DROP INDEX IDX_564122682AD18E6A');
