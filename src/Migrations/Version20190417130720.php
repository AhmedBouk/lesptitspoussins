 ...
 */
final class Version20190417130720 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__parentt AS SELECT id, nom, prenom, mail, ville, codepostal, adresse, telephone, password, created_at, updated_at, created_at_abonnement, statut_abonnement, date_duree, is_enabled, roles, statutcondition, token, password_requested_at FROM parentt');
